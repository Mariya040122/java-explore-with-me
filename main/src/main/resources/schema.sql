...
ALTER TABLE public.events
    ADD CONSTRAINT events_fk_1 FOREIGN KEY (compilation) REFERENCES compilations (id) ON DELETE SET NULL;
ALTER TABLE public.events
    ADD CONSTRAINT events_fk_2 FOREIGN KEY (category) REFERENCES categories (id);
